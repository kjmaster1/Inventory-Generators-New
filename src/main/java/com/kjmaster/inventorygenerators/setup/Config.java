...
public class Config
{
    ...
    private static final ForgeConfigSpec.BooleanValue DO_SIDE_EFFECTS = BUILDER
            .comment("Whether Inventory Generators have side effects or not")
            .define("doSideEffects", true);

    private static final ForgeConfigSpec.BooleanValue DO_SEND_ENERGY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue CULINARY_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue DEATH_GENERATOR_CAPACITY = BUILDER
            .comment("Energy capacity of the inventory death generator")
            .defineInRange("deathGeneratorCapacity", 100000, 0, Integer.MAX_VALUE);

    private static final ForgeConfigSpec.IntValue END_GENERATOR_CAPACITY = BUILDER
            .comment("Energy capacity of the inventory end generator")
            .defineInRange("endGeneratorCapacity", 100000, 0, Integer.MAX_VALUE);

    private static final ForgeConfigSpec.IntValue EXPLOSIVE_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue FROSTY_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue FURNACE_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue HALITOSIS_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue NETHER_STAR_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue OVERCLOCKED_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue PINK_GENERATOR_CAPACITY = BUILDER
            .comment("Energy capacity of the inventory pink generator")
            .defineInRange("pinkGeneratorCapacity", 10000, 0, Integer.MAX_VALUE);

    private static final ForgeConfigSpec.IntValue POTION_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue SLIMEY_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue SURVIVALIST_GENERATOR_CAPACITY = BUILDER
    ...
    private static final ForgeConfigSpec.DoubleValue FURNACE_GENERATOR_DIVISOR = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue FURNACE_GENERATOR_RF_PER_TICK = BUILDER
    ...
    private static final ForgeConfigSpec.DoubleValue OVERCLOCKED_GENERATOR_DIVISOR = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue OVERCLOCKED_GENERATOR_MIN_RF_PER_TICK = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue SURVIVALIST_GENERATOR_RF_PER_TICK = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue EXPLOSIVE_GENERATOR_SIDE_EFFECT_PROBABILITY = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue EXPLOSION_DAMAGE_DIVISOR = BUILDER
    ...
    private static final ForgeConfigSpec.IntValue WITHER_DURATION = BUILDER
